    ...
    <>
      <style>{`
        :root {
          ...
          --bg: #161213; --surface: #1E1819;
          --surface-elevated: #2A1E1F; --surface-card: #221819;
          --text-primary: #FFFFFF; --text-secondary: #A0A0A0; --text-tertiary: #6B6B6B;
          --border: #3A2425; --success: #4ADE80;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
        ...
        .tv-player-placeholder {
          ...
          background: radial-gradient(ellipse at 50% 50%, rgba(217,119,6,0.04) 0%, transparent 70%);
        }
        ...
        .tv-chat-input:focus { border-color: var(--primary); box-shadow: 0 0 0 3px rgba(217,119,6,0.08); }
        ...
        .tv-prayer-input:focus, .tv-prayer-textarea:focus { border-color: var(--primary); box-shadow: 0 0 0 3px rgba(217,119,6,0.08); }
        ...
        .tv-notes-preview-btn.active {
          background: rgba(217,119,6,0.1); border-color: rgba(217,119,6,0.2); color: var(--primary);
        }
        ...
        .tv-notes-textarea:focus { border-color: var(--primary); box-shadow: 0 0 0 3px rgba(217,119,6,0.08); }
        ...
        .tv-notes-search-input:focus { border-color: var(--primary); box-shadow: 0 0 0 3px rgba(217,119,6,0.08); }
        ...
        .giving-amount-btn.selected { border-color: var(--primary); background: rgba(217,119,6,0.1); color: var(--primary); }
        ...
        .giving-method-option.selected { border-color: var(--primary); background: rgba(217,119,6,0.05); }
        ...
        .tv-pl-add-btn {
          width: 28px; height: 28px; border-radius: 6px;
          background: rgba(217,119,6,0.08); border: 1px solid rgba(217,119,6,0.1);
        ...
        .tv-loading-ring {
          ...
          border-top-color: #F59E0B; border-right-color: #D97706;
        ...
        .tv-loading-ring-inner {
          ...
          border-bottom-color: #F59E0B; border-left-color: #D97706;
