...
export default function RadioPage() {
  ...
  const stationName = settings?.name || "MAMLAKA TV Radio";
    ...
    <>
      ...
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
        ...
        .np-glass {
          background: linear-gradient(180deg, rgba(217,119,6,0.08) 0%, rgba(15,15,15,0.4) 100%);
          border: 1px solid rgba(217,119,6,0.12);
          border-radius: 20px;
          padding: 28px 22px 22px;
          position: relative; overflow: hidden;
          box-shadow: 0 8px 32px rgba(0,0,0,0.5), 0 0 60px rgba(217,119,6,0.04);
        }
        .np-glass::before {
        ...
        .np-art { width: 88px; height: 88px; border-radius: 16px; overflow: hidden; flex-shrink: 0; box-shadow: 0 12px 32px rgba(0,0,0,0.5), 0 0 0 2px rgba(217,119,6,0.15); transition: transform 0.3s ease; }
        ...
        .np-progress-fill { height: 100%; background: linear-gradient(90deg, var(--gradient-start), var(--gradient-end)); border-radius: 3px; transition: width 0.5s ease; box-shadow: 0 0 8px rgba(217,119,6,0.3); }
        ...
        .np-vol-slider::-webkit-slider-thumb {
          ...
          background: linear-gradient(135deg, var(--gradient-start), var(--gradient-end));
          cursor: pointer; box-shadow: 0 2px 8px rgba(217,119,6,0.3);
        ...
        .np-bg-indicator { text-align: center; margin-top: 12px; padding: 6px 14px; background: rgba(217,119,6,0.06); border: 1px solid rgba(217,119,6,0.08); border-radius: 20px; display: inline-flex; align-items: center; gap: 6px; font-size: 11px; color: var(--text-tertiary); position: relative; z-index: 1; width: auto; }

        /* ===== LIVE DJ CARD ===== */
        .dj-glass {
          background: linear-gradient(135deg, rgba(239,68,68,0.06) 0%, rgba(217,119,6,0.04) 100%);
        ...
        .dj-avatar { width: 48px; height: 48px; border-radius: var(--radius-full); background: linear-gradient(135deg, var(--gradient-start), var(--gradient-end)); display: flex; align-items: center; justify-content: center; font-size: 20px; color: #fff; flex-shrink: 0; box-shadow: 0 0 20px rgba(217,119,6,0.2); }
        .dj-info { flex: 1; }
        ...
        .timer-option.selected { background: rgba(217,119,6,0.12); }
      ...
      <div className="app-container">
        ...
        <header className="header">
          ...
          <div className="header-info">
            <div className="header-name">MAMLAKA TV MEDIA</div>
