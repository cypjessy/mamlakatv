...
export default function RadioStationPage() {
  ...
  return (
    <>
      ...
      <style>{`
        :root {
          --rs-primary: #D97706; --rs-primary-light: #F59E0B; --rs-primary-dark: #B45309;
          --rs-bg: #161213; --rs-surface: #1E1819; --rs-surface-elevated: #2A1E1F;
          --rs-surface-card: #221819; --rs-surface-hover: #2A1E1F;
          ...
          --rs-overlay: rgba(22,18,19,0.92);
          --rs-grad-start: #D97706; --rs-grad-end: #F59E0B;
          --rs-grad-purple: #D97706; --rs-grad-blue: #3B82F6; --rs-grad-red: #EF4444; --rs-grad-green: #22C55E;
          --rs-shadow-soft: 0 4px 20px rgba(217,119,6,0.15);
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
        ...
        .rs-dj-name {
          ...
          padding: 4px 10px; background: rgba(217,119,6,0.1); border-radius: 20px;
        }
        ...
        .rs-toast-icon.info { background: rgba(217,119,6,0.15); color: var(--rs-primary); }
        ...
        .rs-badge.gold { background: rgba(217,119,6,0.12); color: var(--rs-primary); }
        ...
        .rs-input:focus { border-color: var(--rs-primary); box-shadow: 0 0 0 4px rgba(217,119,6,0.08); }
