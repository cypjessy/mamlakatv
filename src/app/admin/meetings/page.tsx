...
export default function AdminMeetingsPage() {
  ...
  return (
    <>
      <style>{`
        :root { --primary: #D97706; --primary-light: #F59E0B; --primary-dark: #B45309; --bg: #161213; --surface: #1E1819; --surface-elevated: #2A1E1F; --surface-card: #221819; --surface-hover: #2A1E1F; --text-primary: #FFFFFF; --text-secondary: #A0A0A0; --text-tertiary: #6B6B6B; --border: #3A2425; --error: #FF6B6B; --success: #4ADE80; --info: #38BDF8; --warning: #F59E0B; --overlay: rgba(22,18,19,0.92); --gradient-start: #D97706; --gradient-end: #F59E0B; --gradient-purple: #D97706; --gradient-blue: #3B82F6; --gradient-green: #22C55E; --gradient-red: #EF4444; --shadow-soft: 0 4px 20px rgba(217,119,6,0.15); --shadow-elevated: 0 8px 32px rgba(0,0,0,0.5); --radius-sm: 12px; --radius-md: 16px; --radius-lg: 20px; --radius-xl: 24px; --radius-full: 50%; }
                                      ...
                                      <div className="attendance-time" style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                                        ...
                                        <span style={{
                                          ...
                                          background: item.priority === "high" ? "rgba(255,107,107,0.12)"
                                            : item.priority === "medium" ? "rgba(217,119,6,0.12)"
