  ...
  useEffect(() => {
    getRadioConfig().then((config) => {
      if (config) setRadioConfig({
        stationName: config.stationName || "MAMLAKA TV Radio",
      ...
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
        ...
        .rh-art {
            ...
            box-shadow: 0 8px 32px rgba(0,0,0,0.5), 0 0 0 2px rgba(217,119,6,0.1);
        ...
        .rh-play-btn.playing {
            box-shadow: 0 6px 28px rgba(217,119,6,0.4), 0 0 40px rgba(217,119,6,0.1);
        }
        .rh-play-ring {
        ...
        /* Now Playing Card */
        .now-playing-card {
          background: linear-gradient(135deg, rgba(217,119,6,0.08) 0%, rgba(139,92,246,0.04) 100%);
        ...
        .qab-icon.gold { background: rgba(217,119,6,0.12); color: var(--primary); }
        .qab-icon.blue { background: rgba(59,130,246,0.12); color: var(--gradient-blue); }
        .qab-icon.purple { background: rgba(217,119,6,0.12); color: var(--gradient-purple); }
        ...
        .sparkline-fill {
          ...
          background: linear-gradient(to top, rgba(217,119,6,0.3), var(--primary));
        ...
        .upload-zone.dragging {
          background: rgba(217,119,6,0.06); border-color: var(--primary);
        ...
        .media-search-input:focus { border-color: var(--primary); box-shadow: 0 0 0 4px rgba(217,119,6,0.08); }
        ...
        .media-filter-select:focus { border-color: var(--primary); box-shadow: 0 0 0 4px rgba(217,119,6,0.08); }
        ...
        .media-file-item.selected { background: rgba(217,119,6,0.04); }
        ...
        .media-action-icon.gold { background: rgba(217,119,6,0.12); color: var(--primary); }
        ...
        .pl-card.expanded { border-color: rgba(217,119,6,0.2); }
        ...
        .pl-type-badge.scheduled { background: rgba(217,119,6,0.12); color: var(--primary); }
        .pl-type-badge.ondemand { background: rgba(217,119,6,0.12); color: #D97706; }
        ...
        .pl-add-songs-btn:active { background: rgba(217,119,6,0.05); border-color: var(--primary); }
        .pl-schedule-info { display: flex; align-items: center; gap: 8px; padding: 8px 10px; background: rgba(217,119,6,0.06); border-radius: var(--radius-sm); margin-top: 6px; font-size: 12px; color: var(--primary); }
        ...
        .pl-card-new.default { background: rgba(217,119,6,0.03); }
        ...
        .pl-card-new-tag { display: inline-flex; align-items: center; gap: 4px; margin-top: 6px; padding: 3px 8px; border-radius: 4px; font-size: 11px; font-weight: 600; background: rgba(217,119,6,0.08); color: var(--primary); }
        ...
        .pl-detail-schedule { background: rgba(217,119,6,0.04); border: 1px solid rgba(217,119,6,0.1); border-radius: var(--radius-md); padding: 14px; display: flex; flex-direction: column; gap: 10px; }
        ...
        .pl-detail-add-songs-btn:active { border-color: var(--primary); background: rgba(217,119,6,0.03); }
        ...
        .pl-sv-day-header.today { background: rgba(217,119,6,0.1); color: var(--primary); }
        ...
        .pl-sv-cell.today { background: rgba(217,119,6,0.03); }
        ...
        .pl-type-option.active { border-color: var(--primary); background: rgba(217,119,6,0.03); }
        ...
        .pl-order-option.active { border-color: var(--primary); background: rgba(217,119,6,0.03); }
        ...
        @media (max-width: 767px) {
          ...
          .gl-history-icon {
            ...
            background: rgba(217,119,6,0.08); color: var(--primary);
          ...
          .gl-form-note {
            ...
            padding: 10px 12px; background: rgba(217,119,6,0.04);
            border: 1px solid rgba(217,119,6,0.1); border-radius: var(--radius-sm);
