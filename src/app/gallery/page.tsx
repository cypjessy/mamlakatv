...
export default function GalleryPage() {
  ...
  function getCategoryColor(cat: string): string {
    const colors: Record<string, string> = {
      events: "#D97706", services: "#F59E0B", community: "#4ADE80",
      team: "#3B82F6", facility: "#EF4444", general: "#6B6B6B",
      event: "#D97706", prayer: "#D97706", notice: "#3B82F6", urgent: "#EF4444",
    };
    ...
    <>
      <style>{`
        :root {
            ...
            --bg: #161213; --surface: #1E1819; --surface-elevated: #2A1E1F;
            --surface-card: #221819; --surface-hover: #2A1E1F;
            --text-primary: #FFFFFF; --text-secondary: #A0A0A0; --text-tertiary: #6B6B6B;
            --border: #3A2425; --error: #FF6B6B; --success: #4ADE80; --info: #38BDF8;
            --overlay: rgba(22,18,19,0.92); --gradient-start: #D97706; --gradient-end: #F59E0B;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
        ...
        .header-logo { width: 38px; height: 38px; border-radius: 12px; background: linear-gradient(135deg, var(--gradient-start), var(--gradient-end)); display: flex; align-items: center; justify-content: center; font-size: 18px; color: #fff; flex-shrink: 0; box-shadow: 0 4px 16px rgba(217,119,6,0.25); }
        ...
        .tab-btn.active::after { content: ''; position: absolute; bottom: 0; left: 20%; right: 20%; height: 3px; background: linear-gradient(90deg, var(--gradient-start), var(--gradient-end)); border-radius: 3px 3px 0 0; box-shadow: 0 0 12px rgba(217,119,6,0.3); }
        ...
        .hero-cta { display: inline-flex; padding: 10px 22px; background: linear-gradient(135deg, var(--gradient-start), var(--gradient-end)); border: none; border-radius: 10px; color: #fff; font-size: 13px; font-weight: 700; cursor: pointer; width: fit-content; transition: all 0.2s; box-shadow: 0 4px 16px rgba(217,119,6,0.3); }
        ...
        .hero-dot.active { width: 28px; background: linear-gradient(90deg, var(--gradient-start), var(--gradient-end)); border-radius: 3px; box-shadow: 0 0 8px rgba(217,119,6,0.3); }
        ...
        .section-see-all { font-size: 12px; color: var(--primary); font-weight: 700; background: none; border: none; cursor: pointer; display: flex; align-items: center; gap: 4px; padding: 6px 14px; border-radius: 20px; background: rgba(217,119,6,0.08); border: 1px solid rgba(217,119,6,0.15); transition: all 0.2s; }
        .section-see-all:active { background: rgba(217,119,6,0.15); transform: scale(0.95); }
        ...
        .gallery-search input:focus { border-color: var(--primary); background: var(--surface-elevated); box-shadow: 0 0 0 3px rgba(217,119,6,0.08); }
        ...
        .gallery-chip.active { background: linear-gradient(135deg, var(--gradient-start), var(--gradient-end)); border-color: transparent; color: #fff; box-shadow: 0 4px 12px rgba(217,119,6,0.2); }
                ...
                <>
                    ...
                    <>
                      <div className="section-header">
                        <h2 className="section-title">
                          <span className="section-title-icon" style={{ background: "linear-gradient(135deg, #D97706, #F59E0B)" }}><i className="fas fa-star"></i></span>
                          Featured Photos
                        </h2>
                  ...
                  {recentPhotos.length > 0 && (
                    <>
                      <div className="section-header">
                        <h2 className="section-title">
                          <span className="section-title-icon" style={{ background: "linear-gradient(135deg, #D97706, #B45309)" }}><i className="fas fa-clock"></i></span>
                          Recent Photos
                        </h2>
