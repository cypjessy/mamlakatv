...
.lv-msg.own{align-self:flex-end;background:rgba(217,119,6,.1)}
...
.lv-ci:focus{border-color:rgba(217,119,6,.5)}
.lv-ci::placeholder{color:rgba(255,255,255,.25)}
.lv-cs{width:36px;height:36px;border-radius:10px;border:none;background:rgba(217,119,6,.8);color:#fff;font-size:13px;cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0}
...
.lv-in:focus,.lv-ta:focus{border-color:rgba(217,119,6,.5)}
.lv-in::placeholder,.lv-ta::placeholder{color:rgba(255,255,255,.25)}
.lv-pb{padding:8px;border-radius:10px;border:none;background:rgba(217,119,6,.8);color:#fff;font-size:12px;font-weight:600;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px}
...
.lv-pr{margin-top:6px;padding:6px 8px;border-radius:8px;background:rgba(217,119,6,.06);border-left:2px solid rgba(217,119,6,.5)}
.lv-pr-head{font-size:9px;color:rgba(217,119,6,.7);margin-bottom:2px;display:flex;align-items:center;gap:4px}
...
.lv-nc{display:flex;align-items:center;gap:6px;padding:8px 14px;background:rgba(217,119,6,.06);border-bottom:1px solid rgba(255,255,255,.06);flex-shrink:0}
...
.lv-tbb.active{background:rgba(217,119,6,.1);color:rgba(217,119,6,.7);border-color:rgba(217,119,6,.2)}
.lv-tbb:disabled{opacity:.3}
.lv-tbs{width:1px;height:14px;background:rgba(255,255,255,.08);margin:0 1px}
.lv-nspin{font-size:10px;color:rgba(217,119,6,.7);margin-right:2px}
...
.lv-nsb{margin:2px 14px 8px;padding:8px;border-radius:10px;border:none;background:rgba(217,119,6,.8);color:#fff;font-size:12px;font-weight:600;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;flex-shrink:0}
...
.lv-ncrd-open{color:rgba(217,119,6,.8)}
...
.lv-ob code{font-size:11px;padding:1px 3px;border-radius:3px;background:rgba(255,255,255,.08);color:rgba(217,119,6,.8)}
.lv-ob a{color:rgba(217,119,6,.8);text-decoration:underline}
...
.md-code{font-size:11px;padding:1px 3px;border-radius:3px;background:rgba(255,255,255,.08);color:rgba(217,119,6,.8)}
.md-link{color:rgba(217,119,6,.8);text-decoration:underline}
