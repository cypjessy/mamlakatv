...
function RotatingGallery({
  ...
  const galleryAccents = ["var(--primary)", "#D97706", "#22C55E", "#3B82F6", "#EF4444", "#F59E0B", "#EC4899"];
    ...
    <>
      ...
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
        ...
        .fv-card:hover { transform: translateY(-3px); border-color: rgba(217,119,6,0.2); box-shadow: 0 12px 40px rgba(0,0,0,0.3), 0 0 0 1px rgba(217,119,6,0.05); }
        ...
        .fv-cat-dot.worship { background: #D97706; }
        ...
        .fv-play-btn {
            ...
            box-shadow: 0 4px 30px rgba(217,119,6,0.4), 0 0 0 4px rgba(255,255,255,0.1);
            transition: all 0.3s ease;
        }
        .fv-card:hover .fv-play-btn { transform: scale(1.1); box-shadow: 0 6px 40px rgba(217,119,6,0.5), 0 0 0 6px rgba(255,255,255,0.08); }
        ...
        .sc-card:hover { transform: translateY(-4px); border-color: rgba(217,119,6,0.2); box-shadow: 0 10px 30px rgba(0,0,0,0.3); }
        ...
        .sc-cover-fallback { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, rgba(217,119,6,0.08), rgba(217,119,6,0.04)); color: var(--text-tertiary); font-size: 32px; }
        .sc-count {
        ...
        .vg-card:hover { transform: translateY(-3px); border-color: rgba(217,119,6,0.15); box-shadow: 0 8px 25px rgba(0,0,0,0.2); }
