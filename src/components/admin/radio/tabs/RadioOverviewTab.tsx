  ...
  return (
    <div className="overview-content">
      <style>{`
        ...
        .now-playing-card { background: linear-gradient(135deg, rgba(217,119,6,0.08) 0%, rgba(139,92,246,0.04) 100%); border: 1px solid rgba(217,119,6,0.1); border-radius: var(--radius-lg); padding: 16px; display: flex; align-items: center; gap: 14px; }
