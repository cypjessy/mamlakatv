  ...
  return (
    <div className="golive-content">
      <style>{`
        ...
        .gl-history-icon { width: 32px; height: 32px; border-radius: var(--radius-sm); background: rgba(217,119,6,0.08); color: var(--primary); display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
        ...
        .gl-form-note { display: flex; align-items: flex-start; gap: 6px; padding: 10px 12px; background: rgba(217,119,6,0.04); border: 1px solid rgba(217,119,6,0.1); border-radius: var(--radius-sm); font-size: 12px; color: var(--text-secondary); line-height: 1.4; }
