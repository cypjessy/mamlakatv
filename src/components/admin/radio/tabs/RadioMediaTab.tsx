  ...
  return (
    <div className="media-content">
      <style>{`
        ...
        .upload-zone.dragging { background: rgba(217,119,6,0.06); border-color: var(--primary); transform: scale(1.01); }
        ...
        .media-bulk-bar { display: flex; align-items: center; gap: 10px; padding: 10px 14px; background: rgba(217,119,6,0.08); border: 1px solid rgba(217,119,6,0.15); border-radius: var(--radius-md); animation: fadeSlideUp 0.2s ease; }
        ...
        .media-playlist-chip { padding: 2px 8px; border-radius: 4px; font-size: 10px; font-weight: 600; background: rgba(217,119,6,0.1); color: var(--primary); }
        ...
        .media-pl-icon { width: 40px; height: 40px; border-radius: var(--radius-sm); background: rgba(217,119,6,0.1); color: var(--primary); display: flex; align-items: center; justify-content: center; font-size: 18px; flex-shrink: 0; }
