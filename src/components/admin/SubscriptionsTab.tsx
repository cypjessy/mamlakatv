...
const SERVICES: ServiceStatus[] = [
  ...
  { name: "LiveKit Server", icon: "fas fa-video", status: "online", label: "Connected", meta: "WebRTC · 8 rooms", color: "#D97706" },
  ...
  return (
    <>
      <style>{`
        ...
        /* ── VPS Specs ── */
        .vps-card {
          background: linear-gradient(135deg, var(--surface-card) 0%, rgba(217,119,6,0.04) 100%);
      ...
      <div>
        ...
        <div className="billing-card" style={{
          background: `linear-gradient(135deg, ${isPaid ? "rgba(74,222,128,0.08)" : isMissed ? "rgba(239,68,68,0.08)" : "rgba(217,119,6,0.08)"} 0%, var(--surface-card) 100%)`,
          border: `1px solid ${isPaid ? "rgba(74,222,128,0.2)" : isMissed ? "rgba(239,68,68,0.2)" : "rgba(217,119,6,0.2)"}`,
          ...
          <div style={{
            ...
            background: `radial-gradient(circle, ${isPaid ? "rgba(74,222,128,0.08)" : isMissed ? "rgba(239,68,68,0.08)" : "rgba(217,119,6,0.08)"} 0%, transparent 70%)`,
            pointerEvents: "none",
          }} />
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
            ...
            <div style={{
              ...
              background: isTrial
                ...
                : isPaid ? "rgba(74,222,128,0.12)" : isMissed ? "rgba(239,68,68,0.12)" : isPartiallyPaid ? "rgba(251,191,36,0.12)" : "rgba(217,119,6,0.12)",
              color: isTrial
                ? "#3B82F6"
        ...
        <div className="vps-card">
          ...
          <div className="vps-grid" style={{ opacity: showUpgrade && !isUpgraded ? 0.6 : 1, transition: "opacity 0.3s" }}>
            <div className="vps-spec" style={{ borderColor: showUpgrade && !isUpgraded ? "rgba(217,119,6,0.2)" : undefined }}>
