  ...
  return (
    <>
      <style>{`
        ...
        .rs-ov-np { background: linear-gradient(135deg, rgba(217,119,6,0.08), rgba(139,92,246,0.04)); border: 1px solid rgba(217,119,6,0.1); border-radius: var(--rs-radius-lg); padding: 16px; display: flex; align-items: center; gap: 14px; }
        ...
        .rs-ov-action-icon.gold { background: rgba(217,119,6,0.12); color: var(--rs-primary); }
        ...
        .rs-ov-chart-fill { width: 100%; border-radius: 3px 3px 0 0; background: linear-gradient(to top, rgba(217,119,6,0.3), var(--rs-primary)); transition: height 0.3s ease; min-height: 2px; }
