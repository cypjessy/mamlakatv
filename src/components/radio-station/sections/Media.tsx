  ...
  return (
    <>
      <style>{`
        ...
        .rs-media-bulk { display: flex; align-items: center; gap: 10px; padding: 8px 14px; background: rgba(217,119,6,0.08); border: 1px solid rgba(217,119,6,0.15); border-radius: var(--rs-radius-md); animation: rsFadeUp 0.2s ease; }
        ...
        .rs-media-item.selected { background: rgba(217,119,6,0.04); }
        ...
        .rs-media-pl-icon { width: 36px; height: 36px; border-radius: var(--rs-radius-sm); background: rgba(217,119,6,0.1); color: var(--rs-primary); display: flex; align-items: center; justify-content: center; font-size: 16px; }
