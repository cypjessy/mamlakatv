  ...
  return (
    <>
      <style>{`
        ...
        .rs-an-chart-fill { width: 100%; border-radius: 3px 3px 0 0; background: linear-gradient(to top, rgba(217,119,6,0.3), var(--rs-primary)); transition: height 0.3s ease; min-height: 2px; cursor: pointer; position: relative; }
