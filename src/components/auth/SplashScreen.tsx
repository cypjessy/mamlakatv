    ...
    <div className="splash-screen" ref={splashRef}>
      ...
      <style>{`
        ...
        .splash-ring-inner {
          width: 82px;
          height: 82px;
          border-top-color: rgba(247,103,7,0.2);
          border-right-color: rgba(247,103,7,0.1);
          border-bottom-color: transparent;
          border-left-color: rgba(247,103,7,0.1);
        ...
        .splash-logo {
          ...
          align-items: center;
          justify-content: center;
          box-shadow: 0 8px 32px rgba(255,146,43,0.3),
                      0 0 60px rgba(247,103,7,0.15);
          position: relative;
          z-index: 1;
